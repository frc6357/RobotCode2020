...
/**
 * A ThreeRotateCommandGroup that will extend the lifter, turn on the motor, and
 * spin the control panel a little more than three times.
 */
public class ThreeRotateCommandGroup extends SequentialCommandGroup {
    ...
    public ThreeRotateCommandGroup(SK20ColorWheel subsystem, int transitions) {
        addCommands(
                ...
                // Rotates the control panel for the certain amount of transitions set by the
                // constructor.
